# Docker-UrNetwork Releases v2025.9.29-743992480
...
- The proxy inside the proxy.txt should have this format ip:port:username:password see the sample below. one proxy per line.
```
